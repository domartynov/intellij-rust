...
data class RsQualifiedName private constructor(
    ...
    fun findPsiElement(psiManager: PsiManager, context: RsElement): PsiElement? {
    ...
    private fun findCrateRoot(item: Item, psiManager: PsiManager, context: RsElement): PsiFile? {
